...
\mobile{(+56) 9 54 32 33 04} 
%%% Social
\email{maxiosorio@gmail.com}
\homepage{https://mosorio.me}
%%% Optionals
\position{Computer Science Engineer {\enskip\cdotp\enskip} Researcher {\enskip\cdotp\enskip}Linux troubleshooter}
